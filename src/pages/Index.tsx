...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle relative overflow-hidden">
      ...
      <div className="max-w-[95rem] mx-auto p-3 relative z-10">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="relative mb-3">
            <TabsList className="grid w-full grid-cols-1 lg:w-auto lg:grid-cols-4 bg-gradient-card shadow-glow border border-primary/20 backdrop-blur-sm">
              <TabsTrigger
                value="data"
            ...
            <div className="absolute top-2 right-2 flex items-center gap-1">
              {apiConfig.useMockApi ? (
                <div title="Using Mock API">
                  <Database className="h-4 w-4 text-orange-500" />
                </div>
              ) : (
                <div title="Using Real API">
